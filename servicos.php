...
<html>
    <head>
        ...
        ?>
        <title>Paisagismo - Mhterras - Serviços</title>
    </head>
    <body>
        <!-- Menu-->
        ...
        <section id="paisagem">
            <div class="container caixa">
                <h3 class="border-bottom">Serviços - encontre o mais adequado para você!</h3>
                <form action="orcamento.php" method="post">
                    <div class="row mt-3">
                        ...
                        if (isset($tipo) && $tipo != null) {
                            $img = glob("image/servicos/$tipo/*.*");
                            
                            if($img[0] !=null){
                                
                                $img_name = $img;
                                $img_name = str_replace('image/servicos/'.$tipo.'/', '', $img_name);
                            ...
                            <div class="container m-5">
                                <div class="alert alert-warning" role="alert">
                                    ...
                                    <p>
                                        Opss! Desculpe, não encontramos nenhum serviço relacionado,

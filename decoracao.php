...
<html>
    <head>
        ...
        ?>
        <title>Paisagismo - Mhterras - Decorações</title>
    </head>
    <body>
        <!-- Menu-->
        ...
        <section id="paisagem">
            <div class="container caixa">
                <h3 class="border-bottom">Decorações - Torne seu ambiente mais bonito e agradável!</h3>
                <form action="orcamento.php" method="post">
                    <div class="row mt-3">
                        ...
                        if (isset($tipo) && $tipo != null) {
                            $img = glob("image/decoracao/$tipo/*.*");

                            if($img[0] != null){
                                
                                $img_name = $img;
                                $img_name = str_replace('image/decoracao/'.$tipo.'/', '', $img_name);
                            ...
                            <div class="container m-5">
                                <div class="alert alert-warning" role="alert">
                                    <h4 class="alert-heading">Decorações</h4>

                                    <p>
                                        Opss! Desculpe, não encontramos nenhuma decoração relacionado,
                                    ...
                                    <p class="mb-0">
                                        ...
                                        <a href="produtos.php?acao=adubo"><i>Produtos</i></a>, 
                                        <a href="servicos.php?acao=corte"><i>Serviços</i></a> ou 
